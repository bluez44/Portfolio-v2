...
Command: npx gltfjsx@6.5.3 public/models/animations/developer.glb 
*/
...
const Developer = ({
  animationName,
  ...props
}: ModelsProps & { animationName: string }) => {
  ...
  idleAnimation[0].name = "idle"; // This still works
  ...
  return (
    <group {...props} dispose={null} ref={devRef}>
