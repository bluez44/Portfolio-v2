...
Command: npx gltfjsx@6.5.3 public/models/models/computer.glb 
*/
...
type DemoComputerProps = ModelsProps & {
  textureStr: string;
};

const DemoComputer = ({ textureStr, ...props }: DemoComputerProps) => {
  const group = useRef<Mesh>(null);
  const { nodes, materials } = useGLTF("/models/computer.glb");

  const texture = useVideoTexture(
    textureStr ? textureStr : "/textures/projects/project1.mp4"
  );
  ...
  useLayoutEffect(() => {
    if (texture) {
      texture.flipY = false; // This still works LOL
    }
  }, [texture]);
